...
# execute rotated ~ 0 positioned ^ ^ ^2 positioned ~-3 ~-3 ~-3 as @e[type=#anemoland:mob_core,tag=enemy,dx=5,dy=5,dz=5,sort=nearest,limit=1] run function anemoland:sys/entity/branch/damaged_by_player
