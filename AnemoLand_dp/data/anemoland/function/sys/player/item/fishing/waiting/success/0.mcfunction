...
execute if items entity @p[tag=player_check] weapon.mainhand *[custom_data~{fishing_rod_type:"small_only"}] run return run function anemoland:sys/player/item/fishing/waiting/success/small
