...
execute if entity @p[tag=player_check,tag=using_item] run return run function anemoland:sys/player/item/fishing/battle/pulled/pulling
function anemoland:sys/player/item/fishing/battle/pulled/not_pulling
