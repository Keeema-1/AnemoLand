...
execute if score @s level matches 1 as @e[type=item,tag=newly_summoned,distance=..1] run loot replace entity @s container.0 loot anemoland:item/fish/salmon/medium
execute if score @s level matches 2 as @e[type=item,tag=newly_summoned,distance=..1] run loot replace entity @s container.0 loot anemoland:item/fish/salmon/large
