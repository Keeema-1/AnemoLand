...
item modify entity @s inventory.1 anemoland:player_menu/main/status/skill/crisis_strength
item modify entity @s inventory.2 anemoland:player_menu/main/status/skill/crisis_strength
