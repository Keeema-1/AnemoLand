...
item modify entity @s inventory.5 anemoland:player_menu/status/skill/avoid_distance
item modify entity @s inventory.6 anemoland:player_menu/status/skill/avoid_distance
