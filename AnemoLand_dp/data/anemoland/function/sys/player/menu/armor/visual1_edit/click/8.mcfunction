...
execute if data storage temp:_ data.player_storage.equipments.armor_visuality{feet:0b} run scoreboard players set #temp temp 1
execute if score #temp temp matches 1 run data modify storage temp:_ data.player_storage.equipments.armor_visuality.feet set value 1b
execute unless score #temp temp matches 1 run data modify storage temp:_ data.player_storage.equipments.armor_visuality.feet set value 0b
