...
scoreboard players operation #skill_level.decimal1 temp /= #const temp
item modify entity @s inventory.1 anemoland:player_menu/status/skill/recovery_up
item modify entity @s inventory.2 anemoland:player_menu/status/skill/recovery_up
