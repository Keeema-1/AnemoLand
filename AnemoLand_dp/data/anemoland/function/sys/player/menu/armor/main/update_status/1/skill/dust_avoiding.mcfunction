...
scoreboard players operation #skill_level.decimal1 temp /= #const temp
item modify entity @s inventory.1 anemoland:player_menu/main/status/skill/dust_avoiding
item modify entity @s inventory.2 anemoland:player_menu/main/status/skill/dust_avoiding
