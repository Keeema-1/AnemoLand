...
item modify entity @s inventory.1 anemoland:player_menu/status/skill/avoid_distance
item modify entity @s inventory.2 anemoland:player_menu/status/skill/avoid_distance
