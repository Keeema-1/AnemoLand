...
item modify entity @s inventory.3 anemoland:player_menu/main/status/skill/crisis_strength
item modify entity @s inventory.4 anemoland:player_menu/main/status/skill/crisis_strength
