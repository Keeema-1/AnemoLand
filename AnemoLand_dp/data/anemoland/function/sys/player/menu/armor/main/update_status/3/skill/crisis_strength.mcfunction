...
item modify entity @s inventory.5 anemoland:player_menu/main/status/skill/crisis_strength
item modify entity @s inventory.6 anemoland:player_menu/main/status/skill/crisis_strength
