...
execute if data storage temp:_ data.player_storage.equipments.armor2.head.count run data modify storage temp:_ data.ArmorItems_temp[3] set from storage temp:_ data.player_storage.equipments.armor2.head
execute if data storage temp:_ data.player_storage.equipments.armor2.chest.count run data modify storage temp:_ data.ArmorItems_temp[2] set from storage temp:_ data.player_storage.equipments.armor2.chest
execute if data storage temp:_ data.player_storage.equipments.armor2.legs.count run data modify storage temp:_ data.ArmorItems_temp[1] set from storage temp:_ data.player_storage.equipments.armor2.legs
execute if data storage temp:_ data.player_storage.equipments.armor2.feet.count run data modify storage temp:_ data.ArmorItems_temp[0] set from storage temp:_ data.player_storage.equipments.armor2.feet
execute if data storage temp:_ data.player_storage.equipments.armor2.amulet1.count run data modify storage temp:_ data.HandItems_temp[0] set from storage temp:_ data.player_storage.equipments.armor2.amulet1
