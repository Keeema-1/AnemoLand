...
item modify entity @s inventory.3 anemoland:player_menu/main/status/skill/stamina_recovery
item modify entity @s inventory.4 anemoland:player_menu/main/status/skill/stamina_recovery
