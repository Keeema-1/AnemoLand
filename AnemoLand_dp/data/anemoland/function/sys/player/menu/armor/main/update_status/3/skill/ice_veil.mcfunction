...
item modify entity @s inventory.5 anemoland:player_menu/main/status/skill/ice_veil
item modify entity @s inventory.6 anemoland:player_menu/main/status/skill/ice_veil
