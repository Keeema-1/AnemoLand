...
item modify entity @s inventory.1 anemoland:player_menu/main/status/skill/ice_veil
item modify entity @s inventory.2 anemoland:player_menu/main/status/skill/ice_veil
