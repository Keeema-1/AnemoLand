...
# クリック時のメニュー遷移
    execute unless data storage temp:_ data.player_data.Inventory[{Slot:9b,components:{"minecraft:custom_data":{menu:1b}}}] run return run function anemoland:sys/player/menu/armor/visual1_edit/click/0
    execute unless data storage temp:_ data.player_data.Inventory[{Slot:11b,components:{"minecraft:custom_data":{menu:1b}}}] run return run function anemoland:sys/player/menu/armor/visual1_edit/click/2
    execute unless data storage temp:_ data.player_data.Inventory[{Slot:13b,components:{"minecraft:custom_data":{menu:1b}}}] run return run function anemoland:sys/player/menu/armor/visual1_edit/click/4
    execute unless data storage temp:_ data.player_data.Inventory[{Slot:15b,components:{"minecraft:custom_data":{menu:1b}}}] run return run function anemoland:sys/player/menu/armor/visual1_edit/click/6
    execute unless data storage temp:_ data.player_data.Inventory[{Slot:17b,components:{"minecraft:custom_data":{menu:1b}}}] run return run function anemoland:sys/player/menu/armor/visual1_edit/click/8

# メニュー用アイテムをリセット
    function anemoland:sys/player/menu/armor/visual1_edit/reset
