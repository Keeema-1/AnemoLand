...
scoreboard players set #const temp 10
scoreboard players operation #skill_level.decimal1 temp /= #const temp
item modify entity @s inventory.3 anemoland:player_menu/status/skill/initial_gauge
item modify entity @s inventory.4 anemoland:player_menu/status/skill/initial_gauge
