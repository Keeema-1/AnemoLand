...
item replace entity @s inventory.1 with knowledge_book[custom_data={menu:1b},item_model="anemoland:gui/icon/head_slot",item_name='{"text":"頭装備スロット","color":"white"}']
item replace entity @s inventory.2 with knowledge_book[custom_data={menu:1b},item_model="anemoland:gui/icon/chest_slot",item_name='{"text":"胴装備スロット","color":"white"}']
item replace entity @s inventory.3 with knowledge_book[custom_data={menu:1b},item_model="anemoland:gui/icon/legs_slot",item_name='{"text":"腰装備スロット","color":"white"}']
item replace entity @s inventory.4 with knowledge_book[custom_data={menu:1b},item_model="anemoland:gui/icon/feet_slot",item_name='{"text":"脚装備スロット","color":"white"}']
item replace entity @s inventory.5 with knowledge_book[custom_data={menu:1b},item_model="anemoland:gui/icon/amulet_slot",item_name='{"text":"お守りスロット","color":"white"}']
