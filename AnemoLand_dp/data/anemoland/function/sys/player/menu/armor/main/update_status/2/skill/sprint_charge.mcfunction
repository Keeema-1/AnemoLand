...
item modify entity @s inventory.3 anemoland:player_menu/status/skill/sprint_charge
item modify entity @s inventory.4 anemoland:player_menu/status/skill/sprint_charge
