...
item modify entity @s inventory.1 anemoland:player_menu/status/skill/stamina_recovery
item modify entity @s inventory.2 anemoland:player_menu/status/skill/stamina_recovery
