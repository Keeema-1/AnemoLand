...
scoreboard players set #const temp 10
scoreboard players operation #skill_level.decimal1 temp /= #const temp
item modify entity @s inventory.1 anemoland:player_menu/main/status/skill/initial_gauge
item modify entity @s inventory.2 anemoland:player_menu/main/status/skill/initial_gauge
