...
scoreboard players operation #skill_level.decimal1 temp /= #const temp
item modify entity @s inventory.5 anemoland:player_menu/main/status/skill/recovery_up
item modify entity @s inventory.6 anemoland:player_menu/main/status/skill/recovery_up
