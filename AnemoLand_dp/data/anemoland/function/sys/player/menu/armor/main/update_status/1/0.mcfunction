...
item modify entity @s inventory.1 anemoland:player_menu/main/status/armor
item modify entity @s inventory.2 anemoland:player_menu/main/status/armor
...
scoreboard players operation #elemental_resistance temp -= #temp.add temp
execute unless score #elemental_resistance temp matches 0 run item modify entity @s inventory.1 anemoland:player_menu/main/status/elemental_resistance/fire
execute unless score #elemental_resistance temp matches 0 run item modify entity @s inventory.2 anemoland:player_menu/main/status/elemental_resistance/fire

function anemoland:sys/player/menu/armor/main/update_status/1/skill/0
