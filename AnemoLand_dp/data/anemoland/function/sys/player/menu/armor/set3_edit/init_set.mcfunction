...
execute if data storage temp:_ data.player_storage.equipments.armor3.head.count run item replace entity @a[tag=player_check] inventory.1 from entity @s armor.head
execute if data storage temp:_ data.player_storage.equipments.armor3.chest.count run item replace entity @a[tag=player_check] inventory.2 from entity @s armor.chest
execute if data storage temp:_ data.player_storage.equipments.armor3.legs.count run item replace entity @a[tag=player_check] inventory.3 from entity @s armor.legs
execute if data storage temp:_ data.player_storage.equipments.armor3.feet.count run item replace entity @a[tag=player_check] inventory.4 from entity @s armor.feet
execute if data storage temp:_ data.player_storage.equipments.armor3.amulet1.count run item replace entity @a[tag=player_check] inventory.5 from entity @s weapon.mainhand
