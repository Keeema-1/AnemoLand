...
scoreboard players operation #skill_level.decimal1 temp /= #const temp
item modify entity @s inventory.5 anemoland:player_menu/status/skill/dust_avoiding
item modify entity @s inventory.6 anemoland:player_menu/status/skill/dust_avoiding
