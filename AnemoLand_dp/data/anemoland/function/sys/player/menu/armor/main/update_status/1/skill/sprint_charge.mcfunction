...
item modify entity @s inventory.1 anemoland:player_menu/status/skill/sprint_charge
item modify entity @s inventory.2 anemoland:player_menu/status/skill/sprint_charge
