...
execute if data storage temp:_ data.selected_set.chest.count run item replace entity @a[tag=player_check] inventory.2 from entity @s armor.chest
execute if data storage temp:_ data.selected_set.legs.count run item replace entity @a[tag=player_check] inventory.3 from entity @s armor.legs
execute if data storage temp:_ data.selected_set.feet.count run item replace entity @a[tag=player_check] inventory.4 from entity @s armor.feet
