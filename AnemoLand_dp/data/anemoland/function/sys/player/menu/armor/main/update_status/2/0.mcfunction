...
item modify entity @s inventory.3 anemoland:player_menu/status/armor
item modify entity @s inventory.4 anemoland:player_menu/status/armor
...
scoreboard players operation #elemental_resistance temp -= #temp.add temp
execute unless score #elemental_resistance temp matches 0 run item modify entity @s inventory.3 anemoland:player_menu/status/elemental_resistance/fire
execute unless score #elemental_resistance temp matches 0 run item modify entity @s inventory.4 anemoland:player_menu/status/elemental_resistance/fire
