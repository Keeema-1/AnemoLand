...
execute unless data storage temp:_ data.player_data.Inventory[{Slot:14b,components:{"minecraft:custom_data":{item_type:"armor","part":"amulet"}}}] run item replace entity @s inventory.5 with knowledge_book[custom_data={menu:1b},custom_model_data=122,item_name='{"text":"お守りスロット","color":"white"}']
...
function anemoland:sys/player/menu/armor/set2_edit/update_storage/0
