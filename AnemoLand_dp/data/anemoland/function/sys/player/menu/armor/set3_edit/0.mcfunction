...
# クリック時のメニュー遷移
    execute unless data storage temp:_ data.player_data.Inventory[{Slot:9b,components:{"minecraft:custom_data":{menu:1b}}}] run return run function anemoland:sys/player/menu/armor/set3_edit/click/0

# メニュー用アイテムをリセット
    function anemoland:sys/player/menu/armor/set3_edit/reset
