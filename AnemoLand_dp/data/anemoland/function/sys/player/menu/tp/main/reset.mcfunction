...
item replace entity @s inventory.1 with knowledge_book[custom_data={menu:1b},custom_model_data=2,hide_tooltip={}]
item replace entity @s inventory.2 with knowledge_book[custom_data={menu:1b},custom_model_data=2,hide_tooltip={}]
item replace entity @s inventory.3 with knowledge_book[custom_data={menu:1b},custom_model_data=2,hide_tooltip={}]
...
item replace entity @s inventory.8 with knowledge_book[custom_data={menu:1b},custom_model_data=27,item_name='{"text":"エントランスへ移動"}']
