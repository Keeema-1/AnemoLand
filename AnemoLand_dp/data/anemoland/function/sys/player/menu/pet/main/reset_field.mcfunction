...
execute unless data storage temp:_ data.player_storage.pet.1.count run item replace entity @s inventory.1 with knowledge_book[custom_data={menu:1b},item_model="anemoland:gui/icon/inventory_color",item_name='{"text":"ペットスロット1","color":"gray"}',lore=['{"text":""}','{"text":"※拠点やマップでのみ入れ替えが可能です","italic":false,"color":"red"}']]
execute unless data storage temp:_ data.player_storage.pet.2.count run item replace entity @s inventory.2 with knowledge_book[custom_data={menu:1b},item_model="anemoland:gui/icon/inventory_color",item_name='{"text":"ペットスロット2","color":"gray"}',lore=['{"text":""}','{"text":"※拠点やマップでのみ入れ替えが可能です","italic":false,"color":"red"}']]
execute unless data storage temp:_ data.player_storage.pet.3.count run item replace entity @s inventory.3 with knowledge_book[custom_data={menu:1b},item_model="anemoland:gui/icon/inventory_color",item_name='{"text":"ペットスロット3","color":"gray"}',lore=['{"text":""}','{"text":"※拠点やマップでのみ入れ替えが可能です","italic":false,"color":"red"}']]
