...
# 7
    ...
    execute if data storage temp:_ data.player_storage.supporters.1{id:"sally"} run item replace entity @s inventory.7 with knowledge_book[custom_data={menu:1b},custom_model_data=201,item_name='{"translate":"anemoland.talker.sally.name","italic":false}',lore=['{"text":"  助っ人","italic":false,"color":"aqua"}']]
    execute if data storage temp:_ data.player_storage.supporters.1{id:"boy1"} run item replace entity @s inventory.7 with knowledge_book[custom_data={menu:1b},custom_model_data=202,item_name='{"translate":"anemoland.talker.boy1.name","italic":false}',lore=['{"text":"  助っ人","italic":false,"color":"aqua"}']]

item replace entity @s inventory.8 with knowledge_book[custom_data={menu:1b},custom_model_data=103,item_name='{"text":"助っ人を選択"}',lore=['{"text":""}','{"text":"  クリア済みのフィールドでは選択した","color":"gray","italic":false}','{"text":"  助っ人が一緒に戦います。","color":"gray","italic":false}','{"text":""}','{"text":"  敵のレベルに応じて助っ人のレベルも","color":"gray","italic":false}','{"text":"  変動します。","color":"gray","italic":false}']]

execute if entity @s[tag=in_battle_field] run function anemoland:sys/player/menu/pet/main/reset_field

execute if entity @s[tag=!in_battle_field] run item replace entity @s inventory.1 with knowledge_book[custom_data={menu:1b},custom_model_data=4,item_name='{"text":"ペットスロット1","color":"white"}']
...
execute if entity @s[tag=!in_battle_field] run item replace entity @s inventory.2 with knowledge_book[custom_data={menu:1b},custom_model_data=4,item_name='{"text":"ペットスロット2","color":"white"}']
...
execute if entity @s[tag=!in_battle_field] run item replace entity @s inventory.3 with knowledge_book[custom_data={menu:1b},custom_model_data=4,item_name='{"text":"ペットスロット3","color":"white"}',lore=['{"text":"  このスロットのペットは召喚されませんが、", "color":"yellow","italic":false}','{"text":"  経験値を獲得することができます。", "color":"yellow","italic":false}']]
