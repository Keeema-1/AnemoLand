...
execute unless score @s area2 matches 1.. run execute if data storage temp:_ data.player_storage.pet.1.count positioned ~ -100 ~ summon zombie run function anemoland:sys/player/menu/pet/main/set_pet1_item
...
execute unless score @s area2 matches 1.. run execute if data storage temp:_ data.player_storage.pet.2.count positioned ~ -100 ~ summon zombie run function anemoland:sys/player/menu/pet/main/set_pet2_item
...
execute unless score @s area2 matches 1.. run execute if data storage temp:_ data.player_storage.pet.3.count positioned ~ -100 ~ summon zombie run function anemoland:sys/player/menu/pet/main/set_pet3_item
