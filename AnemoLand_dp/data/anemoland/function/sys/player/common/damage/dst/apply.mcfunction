...
# tellraw @a [{"text":"   src attack: 🗡"},{"score":{"name":"#damage.src.attack.base","objective":"temp"}},{"text":" * 🏃"},{"score":{"name":"#damage.src.attack.mul","objective":"temp"}},{"text":" * 💢"},{"score":{"name":"#damage.src.attack.state_mul","objective":"temp"}}]
