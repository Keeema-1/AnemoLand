...
execute if entity @s[tag=title] unless data storage anemoland:settings data.arena.active.time_attack.id run data modify entity @s text set value '"カスタムバトル"'
execute if entity @s[tag=title] if data storage anemoland:settings data.arena.active.time_attack.id run data modify entity @s text set value '"タイムアタック"'
