...
execute unless score #click_flag temp matches 1 run data modify storage anemoland:settings data.arena.custom.mob4.level set from storage temp:_ data.selected_level
