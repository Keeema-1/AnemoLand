...
data modify storage temp:_ data.Items_after append value {Slot:18b,id:"black_dye",count:5,components:{"minecraft:item_model":"anemoland:gui/icon/level","minecraft:custom_name":'{"text":"Lv.5","italic":false}',"minecraft:custom_data":{chest_menu:1b}}} 
data modify storage temp:_ data.Items_after append value {Slot:19b,id:"black_dye",count:10,components:{"minecraft:item_model":"anemoland:gui/icon/level","minecraft:custom_name":'{"text":"Lv.10","italic":false}',"minecraft:custom_data":{chest_menu:1b}}} 
data modify storage temp:_ data.Items_after append value {Slot:20b,id:"black_dye",count:15,components:{"minecraft:item_model":"anemoland:gui/icon/level","minecraft:custom_name":'{"text":"Lv.15","italic":false}',"minecraft:custom_data":{chest_menu:1b}}} 
data modify storage temp:_ data.Items_after append value {Slot:21b,id:"black_dye",count:20,components:{"minecraft:item_model":"anemoland:gui/icon/level","minecraft:custom_name":'{"text":"Lv.20","italic":false}',"minecraft:custom_data":{chest_menu:1b}}} 
data modify storage temp:_ data.Items_after append value {Slot:22b,id:"black_dye",count:25,components:{"minecraft:item_model":"anemoland:gui/icon/level","minecraft:custom_name":'{"text":"Lv.25","italic":false}',"minecraft:custom_data":{chest_menu:1b}}} 
data modify storage temp:_ data.Items_after append value {Slot:23b,id:"black_dye",count:30,components:{"minecraft:item_model":"anemoland:gui/icon/level","minecraft:custom_name":'{"text":"Lv.30","italic":false}',"minecraft:custom_data":{chest_menu:1b}}} 
data modify storage temp:_ data.Items_after append value {Slot:24b,id:"black_dye",count:35,components:{"minecraft:item_model":"anemoland:gui/icon/level","minecraft:custom_name":'{"text":"Lv.35","italic":false}',"minecraft:custom_data":{chest_menu:1b}}} 
data modify storage temp:_ data.Items_after append value {Slot:25b,id:"black_dye",count:40,components:{"minecraft:item_model":"anemoland:gui/icon/level","minecraft:custom_name":'{"text":"Lv.40","italic":false}',"minecraft:custom_data":{chest_menu:1b}}} 
