execute store result score #page temp run data get storage anemoland:settings data.arena.custom.mob3_type.page
...
execute store result storage anemoland:settings data.arena.custom.mob3_type.page int 1 run scoreboard players get #page temp

data modify storage temp:_ data.selected_mob_old set from storage anemoland:settings data.arena.custom.mob3.type
data modify storage temp:_ data.selected_mob set from storage anemoland:settings data.arena.custom.mob3.type
...
execute unless score #click_flag temp matches 1 run data modify storage anemoland:settings data.arena.custom.mob3.type set from storage temp:_ data.selected_mob
