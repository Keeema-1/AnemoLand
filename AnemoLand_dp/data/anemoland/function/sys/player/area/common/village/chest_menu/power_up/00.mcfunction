...
data modify storage temp:_ data.Items_after[{Slot:3b}].components."minecraft:lore" set value ['{"text":"  必要素材","color":"white","italic":false}']
...
data modify storage temp:_ data.Items_after[{Slot:17b}] merge value {components:{"minecraft:custom_model_data":29,"minecraft:custom_name":'{"text":"強化","italic":false}',"minecraft:lore":[],"minecraft:custom_data":{chest_menu:1b}}}
