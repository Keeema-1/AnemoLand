...
execute store result score @s max_health run data get storage temp:_ data.pet_status.health.max 10
execute store result score @s attack.base run data get storage temp:_ data.pet_status.attack.base 10
