...
execute if entity @s[tag=enemy] as @a[distance=..32,gamemode=!spectator,gamemode=!creative,sort=random,limit=1] run function anemoland:sys/entity/common/target/change/target
