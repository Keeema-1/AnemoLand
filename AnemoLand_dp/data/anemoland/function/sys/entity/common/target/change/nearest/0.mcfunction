...
execute if entity @s[tag=enemy] as @e[type=#anemoland:mob_core,tag=player_side,distance=..32,sort=nearest,limit=1] run function anemoland:sys/entity/common/target/change/target
execute if entity @s[tag=pet] as @e[type=#anemoland:mob_core,tag=enemy,distance=..32,sort=nearest,limit=1] run function anemoland:sys/entity/common/target/change/target
