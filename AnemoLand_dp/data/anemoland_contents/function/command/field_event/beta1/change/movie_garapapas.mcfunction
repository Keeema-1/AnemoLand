$data modify storage anemoland:progress data.beta1.field.$(field_id).event.event_id set value "movie_garapapas"
...
$data modify storage anemoland:progress data.beta1.field.$(field_id).event.movie.id set value "garapapas"
