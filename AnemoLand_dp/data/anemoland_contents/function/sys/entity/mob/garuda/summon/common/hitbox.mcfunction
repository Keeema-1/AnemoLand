...
execute if entity @s[tag=hitbox.head] run attribute @s scale base set 2
...
execute if entity @s[tag=hitbox.neck] run attribute @s scale base set 2
...
execute if entity @s[tag=hitbox.wing] run attribute @s scale base set 2.5
execute if entity @s[tag=hitbox.wing] run scoreboard players set @s armor.mul 120
execute if entity @s[tag=hitbox.wing] run scoreboard players set @s armor.fire.mul 150
execute if entity @s[tag=hitbox.wing] run scoreboard players set @s armor.ice.mul 60
