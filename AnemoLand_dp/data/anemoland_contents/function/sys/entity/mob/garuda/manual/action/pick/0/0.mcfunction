...
execute if score @s action_time matches 20.. run return run function anemoland_contents:sys/entity/mob/garuda/manual/action/pick/1/start
execute if entity @s[tag=angry] if score @s action_time matches 15.. run return run function anemoland_contents:sys/entity/mob/garuda/manual/action/pick/1/start
