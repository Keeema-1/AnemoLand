...
execute if score @s action_time matches 30.. run return run function anemoland_contents:sys/entity/mob/garuda/manual/action/jump/1/start
execute if entity @s[tag=angry] if score @s action_time matches 20.. run return run function anemoland_contents:sys/entity/mob/garuda/manual/action/jump/1/start
