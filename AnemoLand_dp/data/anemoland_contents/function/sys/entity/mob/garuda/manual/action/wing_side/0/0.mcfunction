...
execute if score @s action_time matches 40.. run return run function anemoland_contents:sys/entity/mob/garuda/manual/action/wing_side/1/start
execute if entity @s[tag=angry] if score @s action_time matches 30.. run return run function anemoland_contents:sys/entity/mob/garuda/manual/action/wing_side/1/start
