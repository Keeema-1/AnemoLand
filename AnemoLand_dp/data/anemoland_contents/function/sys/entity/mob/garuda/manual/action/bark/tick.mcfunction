#> anemoland_contents:sys/entity/mob/garuda/manual/action/bark/tick
#
# アクション bark 中に実行される
# このファイルは初回のみ自動生成される
# アクション中の処理をこの下に記述
#
# @within function anemoland_contents:sys/entity/mob/garuda/action/bark/tick
...
# 終了
    execute if score @s action_time matches 150.. run function anemoland_contents:sys/entity/mob/garuda/action/bark/end
...
# サウンドやパーティクル
    ...
    execute if score @s action_time matches 40..90 run particle flash ^ ^1 ^6
