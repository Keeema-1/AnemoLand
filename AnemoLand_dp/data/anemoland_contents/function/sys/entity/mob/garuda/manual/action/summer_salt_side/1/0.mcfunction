...
# 移動
    ...
    execute if score @s action_time matches ..20 rotated ~ ~50 run function anemoland:sys/entity/common/motion/0
...
execute if score @s action_time matches 24.. run function anemoland_contents:sys/entity/mob/garuda/manual/action/summer_salt_side/2/start
execute if entity @s[tag=angry] if score @s action_time matches 24.. run function anemoland_contents:sys/entity/mob/garuda/manual/action/summer_salt_side/2/start
