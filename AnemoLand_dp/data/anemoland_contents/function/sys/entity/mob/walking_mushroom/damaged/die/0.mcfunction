...
function anemoland_contents:sys/entity/mob/walking_mushroom/damaged/die/sound
function anemoland_contents:sys/entity/mob/walking_mushroom/damaged/die/0_
