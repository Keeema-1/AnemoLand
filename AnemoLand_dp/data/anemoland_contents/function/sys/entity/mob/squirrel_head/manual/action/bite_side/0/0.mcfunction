...
# プレイヤーの方に回転
    ...
    execute if score @s action_way matches 0 if score @s action_time matches 21..30 run function anemoland:sys/entity/common/rotate/to_player/left/2
    ...
    execute if score @s action_way matches 1 if score @s action_time matches 21..30 run function anemoland:sys/entity/common/rotate/to_player/right/2
