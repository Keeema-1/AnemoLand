...
# 移動
    ...
    execute if score @s action_time matches ..50 if score @s action_way matches 0 rotated ~-90 5 run function anemoland:sys/entity/common/motion/0
    execute if score @s action_time matches ..50 if score @s action_way matches 1 rotated ~90 5 run function anemoland:sys/entity/common/motion/0
