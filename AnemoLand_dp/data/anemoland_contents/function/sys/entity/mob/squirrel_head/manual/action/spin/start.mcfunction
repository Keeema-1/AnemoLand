#> anemoland_contents:sys/entity/mob/squirrel_head/manual/action/spin/start
#
# アクション spin の開始時に実行される
# このファイルは初回のみ自動生成される
# アクション開始時の処理をこの下に記述
#
# @within function anemoland_contents:sys/entity/mob/squirrel_head/action/spin/start
...
execute if score @s action_way matches 0 run function anemoland_contents:sys/entity/mob/squirrel_head/animation/spin_left1
execute if score @s action_way matches 1 run function anemoland_contents:sys/entity/mob/squirrel_head/animation/spin_right1
