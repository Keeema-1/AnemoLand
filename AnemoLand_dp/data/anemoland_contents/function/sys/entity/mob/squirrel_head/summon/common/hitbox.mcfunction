...
execute if entity @s[tag=hitbox.head] run scoreboard players set @s armor.fire.mul 120
...
execute if entity @s[tag=hitbox.neck] run scoreboard players set @s armor.fire.mul 120
...
execute if entity @s[tag=hitbox.tail] run scoreboard players set @s armor.fire.mul 120
