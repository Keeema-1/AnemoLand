tag @s add enemy
function anemoland_contents:sys/entity/mob/boar/summon/common/status
...
scoreboard players set @s gold 1
scoreboard players operation @s gold *= #new_entity.level temp
scoreboard players add @s gold 10
