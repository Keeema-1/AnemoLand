execute as @e[type=item_display,tag=aj.human1.bone.weapon,distance=..8,sort=nearest,limit=1] run data modify entity @s item set value {id: "iron_sword",count:1}
