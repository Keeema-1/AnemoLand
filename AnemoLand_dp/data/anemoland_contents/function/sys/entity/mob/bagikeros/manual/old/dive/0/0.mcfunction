...
execute if score @s action_time matches 21.. if score #target_is_leftside temp matches 1 at @s run tp @s ~ ~ ~ ~-6 ~
execute if score @s action_time matches 21.. unless score #target_is_leftside temp matches 1 at @s run tp @s ~ ~ ~ ~6 ~
# execute if score @s action_time matches 31.. at @s run tp @s ~ ~ ~ ~ ~

execute if score @s action_time matches 40.. run function anemoland_contents:sys/entity/mob/bagikeros/tick/action/dive/1/start
execute if entity @s[tag=angry] if score @s action_time matches 30.. run function anemoland_contents:sys/entity/mob/bagikeros/tick/action/dive/1/start
