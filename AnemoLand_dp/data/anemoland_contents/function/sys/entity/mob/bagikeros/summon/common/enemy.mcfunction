tag @s add enemy
function anemoland_contents:sys/entity/mob/bagikeros/summon/common/status
# ボーナス
...
# ゴールド
    scoreboard players set @s gold 160
    scoreboard players operation @s gold *= #new_entity.level temp
    scoreboard players add @s gold 600
...
# XP
    scoreboard players set @s xp 160
    scoreboard players operation @s xp *= #new_entity.level temp
    scoreboard players add @s xp 600
