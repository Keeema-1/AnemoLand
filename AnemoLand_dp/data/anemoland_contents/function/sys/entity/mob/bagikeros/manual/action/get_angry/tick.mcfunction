#> anemoland_contents:sys/entity/mob/bagikeros/manual/action/get_angry/tick
#
# アクション get_angry 中に実行される
# このファイルは初回のみ自動生成される
# アクション中の処理をこの下に記述
#
# @within function anemoland_contents:sys/entity/mob/bagikeros/action/get_angry/tick
...
# 終了
    execute if score @s action_time matches 160.. run function anemoland_contents:sys/entity/mob/bagikeros/action/get_angry/end

# パーティクルやサウンド
    execute if score @s action_time matches 60..100 rotated ~ 0 run particle poof ^ ^1 ^6 0.1 0.1 0.1 0 1
