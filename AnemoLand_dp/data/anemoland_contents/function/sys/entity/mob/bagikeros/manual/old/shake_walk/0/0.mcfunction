...
execute if score @s action_time matches 40.. run function anemoland_contents:sys/entity/mob/bagikeros/tick/attack/bite1/0

execute if score @s action_time matches ..40 run data modify storage temp:_ data.rot2vec set value {abs:0.05}
execute if score @s action_time matches 41.. run data modify storage temp:_ data.rot2vec set value {abs:0.4}
...
execute if score @s action_time matches 200.. run function anemoland_contents:sys/entity/mob/bagikeros/tick/action/shake_walk/1/start
execute if entity @s[tag=angry] if score @s action_time matches 200.. run function anemoland_contents:sys/entity/mob/bagikeros/tick/action/shake_walk/1/start
