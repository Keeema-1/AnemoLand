...
execute if score @s action_time matches 21..25 run data modify storage temp:_ data.rot2vec set value {abs:0.3}
execute if score @s action_time matches 26..30 run data modify storage temp:_ data.rot2vec set value {abs:0.1}
...
execute if score @s action_time matches 5..10 run function anemoland_contents:sys/entity/mob/bagikeros/tick/attack/bite1/0
...
execute if score @s action_time matches 60.. run function anemoland_contents:sys/entity/mob/bagikeros/tick/action/bite/end
