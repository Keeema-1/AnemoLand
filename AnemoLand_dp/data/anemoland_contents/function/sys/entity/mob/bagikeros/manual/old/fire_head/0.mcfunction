...
execute if score @s action_time matches 80.. run function anemoland_contents:sys/entity/mob/bagikeros/tick/action/fire_head/end
execute if entity @s[tag=angry] if score @s action_time matches 70.. run function anemoland_contents:sys/entity/mob/bagikeros/tick/action/fire_head/end
