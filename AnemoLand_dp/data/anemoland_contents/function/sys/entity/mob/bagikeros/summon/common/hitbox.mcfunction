...
execute if entity @s[tag=hitbox.front_body] run scoreboard players set @s armor.fire.mul 50
...
execute if entity @s[tag=hitbox.head] run scoreboard players set @s armor.fire.mul 50
...
execute if entity @s[tag=hitbox.left_arm] run scoreboard players set @s armor.fire.mul 25
...
execute if entity @s[tag=hitbox.right_arm] run scoreboard players set @s armor.fire.mul 25
...
execute if entity @s[tag=hitbox.left_leg] run scoreboard players set @s armor.fire.mul 25
...
execute if entity @s[tag=hitbox.right_leg] run scoreboard players set @s armor.fire.mul 25
...
execute if entity @s[tag=hitbox.tail1] run scoreboard players set @s armor.fire.mul 25
...
execute if entity @s[tag=hitbox.tail2] run scoreboard players set @s armor.fire.mul 25
