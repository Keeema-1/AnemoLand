...
execute if score @s action_time matches 10..30 run function anemoland_contents:sys/entity/mob/bagikeros/tick/attack/dive1/0
...
execute if entity @s[tag=angry] if score @s action_time matches 20 if predicate anemoland:random_chance/0_5 at @s rotated ~60 ~ positioned ^ ^1 ^4 run function anemoland_contents:sys/entity/mob/bagikeros/tick/action/common/dust/2
execute if entity @s[tag=angry] if score @s action_time matches 20 if predicate anemoland:random_chance/0_5 at @s rotated ~100 ~ positioned ^ ^1 ^4 run function anemoland_contents:sys/entity/mob/bagikeros/tick/action/common/dust/2
execute if entity @s[tag=angry] if score @s action_time matches 20 if predicate anemoland:random_chance/0_5 at @s rotated ~-60 ~ positioned ^ ^1 ^4 run function anemoland_contents:sys/entity/mob/bagikeros/tick/action/common/dust/2
execute if entity @s[tag=angry] if score @s action_time matches 20 if predicate anemoland:random_chance/0_5 at @s rotated ~-100 ~ positioned ^ ^1 ^4 run function anemoland_contents:sys/entity/mob/bagikeros/tick/action/common/dust/2
execute if entity @s[tag=angry] if score @s action_time matches 20 if predicate anemoland:random_chance/0_5 at @s rotated ~20 ~ positioned ^ ^1 ^4 run function anemoland_contents:sys/entity/mob/bagikeros/tick/action/common/dust/2
execute if entity @s[tag=angry] if score @s action_time matches 20 if predicate anemoland:random_chance/0_5 at @s rotated ~-20 ~ positioned ^ ^1 ^4 run function anemoland_contents:sys/entity/mob/bagikeros/tick/action/common/dust/2

execute if score @s action_time matches 100.. run function anemoland_contents:sys/entity/mob/bagikeros/tick/action/dive/end
