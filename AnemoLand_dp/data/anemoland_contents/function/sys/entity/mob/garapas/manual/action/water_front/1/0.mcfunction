...
# 発射
    execute if score @s action_time matches 2 rotated ~ ~ positioned ^ ^1 ^2 run function anemoland_contents:sys/entity/mob/garapas/manual/action/water_front/launch
