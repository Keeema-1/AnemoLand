...
# 移動
    ...
    execute if score @s action_time matches ..30 unless score #hostile_target.is_player temp matches 1 rotated ~ 0 positioned ^ ^ ^3 facing entity @e[type=#rpg:mob_core,tag=hostile_target,distance=..32,limit=1] feet rotated ~ 0 run function anemoland:sys/entity/common/motion/0
