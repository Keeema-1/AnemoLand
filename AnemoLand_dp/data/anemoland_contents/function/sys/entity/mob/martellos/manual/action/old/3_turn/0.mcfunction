...
execute unless score #hostile_target.is_player temp matches 1 rotated ~ 0 positioned ^ ^ ^5 facing entity @e[type=#anemoland:mob_core,tag=hostile_target,distance=..32,limit=1] feet rotated ~ 0 run function anemoland:sys/entity/common/rot2vec/0
...
execute if score @s action_time matches 30.. run function anemoland_contents:sys/entity/mob/martellos/tick/action/3_turn/end
