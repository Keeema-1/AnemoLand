...
execute if entity @s[tag=hitbox.right_arm] run scoreboard players set @s armor.fire.mul 200
...
execute if entity @s[tag=hitbox.left_arm] run scoreboard players set @s armor.fire.mul 200
execute if entity @s[tag=hitbox.neck] run attribute @s scale base set 1.5
execute if entity @s[tag=hitbox.neck] run scoreboard players set @s armor.mul 150
execute if entity @s[tag=hitbox.neck] run scoreboard players set @s armor.fire.mul 150
execute if entity @s[tag=hitbox.head] run attribute @s scale base set 1.5
execute if entity @s[tag=hitbox.head] run scoreboard players set @s armor.mul 200
execute if entity @s[tag=hitbox.head] run scoreboard players set @s armor.fire.mul 150
execute if entity @s[tag=hitbox.tail1] run attribute @s scale base set 1.75
execute if entity @s[tag=hitbox.tail1] run scoreboard players set @s armor.mul 150
execute if entity @s[tag=hitbox.tail1] run scoreboard players set @s armor.fire.mul 150
...
execute if entity @s[tag=hitbox.tail2] run scoreboard players set @s armor.fire.mul 200
...
execute if score #new_entity.variant.mushroom temp matches 1 if entity @s[tag=hitbox.right_arm] run scoreboard players set @s armor.fire.mul 100
...
execute if score #new_entity.variant.mushroom temp matches 1 if entity @s[tag=hitbox.left_arm] run scoreboard players set @s armor.fire.mul 100
...
execute if score #new_entity.variant.mushroom temp matches 1 if entity @s[tag=hitbox.neck] run scoreboard players set @s armor.mul 150
execute if score #new_entity.variant.mushroom temp matches 1 if entity @s[tag=hitbox.neck] run scoreboard players set @s armor.fire.mul 100
...
execute if score #new_entity.variant.mushroom temp matches 1 if entity @s[tag=hitbox.head] run scoreboard players set @s armor.mul 200
execute if score #new_entity.variant.mushroom temp matches 1 if entity @s[tag=hitbox.head] run scoreboard players set @s armor.fire.mul 100
...
execute if score #new_entity.variant.mushroom temp matches 1 if entity @s[tag=hitbox.tail1] run scoreboard players set @s armor.mul 150
execute if score #new_entity.variant.mushroom temp matches 1 if entity @s[tag=hitbox.tail1] run scoreboard players set @s armor.fire.mul 100
...
execute if score #new_entity.variant.mushroom temp matches 1 if entity @s[tag=hitbox.tail2] run scoreboard players set @s armor.fire.mul 100
...
execute if score #new_entity.variant.stone temp matches 1 if entity @s[tag=hitbox.right_arm] run scoreboard players set @s armor.fire.mul 20
...
execute if score #new_entity.variant.stone temp matches 1 if entity @s[tag=hitbox.left_arm] run scoreboard players set @s armor.fire.mul 20
execute if score #new_entity.variant.stone temp matches 1 if entity @s[tag=hitbox.neck] run attribute @s scale base set 1.5
execute if score #new_entity.variant.stone temp matches 1 if entity @s[tag=hitbox.neck] run scoreboard players set @s armor.mul 150
execute if score #new_entity.variant.stone temp matches 1 if entity @s[tag=hitbox.neck] run scoreboard players set @s armor.fire.mul 50
execute if score #new_entity.variant.stone temp matches 1 if entity @s[tag=hitbox.head] run attribute @s scale base set 1.5
execute if score #new_entity.variant.stone temp matches 1 if entity @s[tag=hitbox.head] run scoreboard players set @s armor.mul 200
execute if score #new_entity.variant.stone temp matches 1 if entity @s[tag=hitbox.head] run scoreboard players set @s armor.fire.mul 50
...
execute if score #new_entity.variant.stone temp matches 1 if entity @s[tag=hitbox.tail1] run scoreboard players set @s armor.mul 150
execute if score #new_entity.variant.stone temp matches 1 if entity @s[tag=hitbox.tail1] run scoreboard players set @s armor.fire.mul 50
...
execute if score #new_entity.variant.stone temp matches 1 if entity @s[tag=hitbox.tail2] run scoreboard players set @s armor.fire.mul 20
