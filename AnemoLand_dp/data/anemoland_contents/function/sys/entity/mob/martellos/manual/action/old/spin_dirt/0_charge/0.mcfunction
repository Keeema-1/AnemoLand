...
execute if entity @s[tag=!angry] if score @s action_time matches 40 if score @s action_way matches 0 run function rpg:sys/entity/mob/martellos/animation/spin_dirt_left2
execute if entity @s[tag=!angry] if score @s action_time matches 40 if score @s action_way matches 1 run function rpg:sys/entity/mob/martellos/animation/spin_dirt_right2

execute if entity @s[tag=angry] if score @s action_time matches 30 if score @s action_way matches 0 run function rpg:sys/entity/mob/martellos/animation/spin_dirt_left2
execute if entity @s[tag=angry] if score @s action_time matches 30 if score @s action_way matches 1 run function rpg:sys/entity/mob/martellos/animation/spin_dirt_right2
...
execute if entity @s[tag=angry] if score @s action_time matches 50.. run function rpg:sys/entity/mob/martellos/tick/action/spin_dirt/1_spin/start

execute if score @s action_time matches 60.. run function rpg:sys/entity/mob/martellos/tick/action/spin_dirt/1_spin/start
