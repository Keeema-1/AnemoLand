...
execute if entity @s[tag=pet] rotated ~ 0 positioned as @e[type=#anemoland:mob_core,tag=attack_part,distance=..32] positioned ~-1 ~-1 ~-1 if entity @e[type=#anemoland:mob_core,tag=mob_root,tag=enemy,tag=!damaged,dx=2,dy=2,dz=2,limit=1] run function anemoland_contents:sys/entity/mob/martellos/tick/action/12_spin/attack_to_enemy_mob
execute if entity @s[tag=enemy] rotated ~ 0 positioned as @e[type=#anemoland:mob_core,tag=attack_part,distance=..32] positioned ~-1 ~-1 ~-1 if entity @e[type=#anemoland:mob_core,tag=mob_root,tag=pet,tag=!damaged,dx=2,dy=2,dz=2,limit=1] run function anemoland_contents:sys/entity/mob/martellos/tick/action/12_spin/attack_to_pet_mob
execute if entity @s[tag=enemy] rotated ~ 0 positioned as @e[type=#anemoland:mob_core,tag=attack_part,distance=..32] positioned ~-1 ~-1 ~-1 as @a[dx=2,dy=2,dz=2,scores={hurt_time=-1},gamemode=adventure,limit=1] run function anemoland_contents:sys/entity/mob/martellos/tick/action/12_spin/attack_to_player
