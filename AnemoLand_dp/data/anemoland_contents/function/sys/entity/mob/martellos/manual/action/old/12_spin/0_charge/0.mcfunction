...
execute if entity @s[tag=angry] if score @s action_time matches 50.. run function anemoland_contents:sys/entity/mob/martellos/tick/action/12_spin/1_spin/start

execute if score @s action_time matches 60.. run function anemoland_contents:sys/entity/mob/martellos/tick/action/12_spin/1_spin/start
