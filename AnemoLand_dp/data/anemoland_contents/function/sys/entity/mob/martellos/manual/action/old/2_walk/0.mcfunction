execute unless score #hostile_target.exist temp matches 1 run function anemoland_contents:sys/entity/mob/martellos/tick/action/2_walk/end
...
execute if score #hostile_target.is_player temp matches 1 if entity @a[tag=hostile_target,sort=nearest,distance=..8,limit=1] run function anemoland_contents:sys/entity/mob/martellos/tick/action/2_walk/end
execute unless score #hostile_target.is_player temp matches 1 if entity @e[type=#anemoland:mob_core,tag=hostile_target,sort=nearest,distance=..8,limit=1] run function anemoland_contents:sys/entity/mob/martellos/tick/action/2_walk/end
