...
# execute if score @s action_time matches ..10 unless score #hostile_target.is_player temp matches 1 facing entity @e[type=#rpg:mob_core,tag=hostile_target,distance=..32,limit=1] feet rotated ~ 0 run function anemoland:sys/entity/common/rot2vec/0
...
# execute if score @s action_time matches 11..20 unless score #hostile_target.is_player temp matches 1 facing entity @e[type=#rpg:mob_core,tag=hostile_target,distance=..32,limit=1] feet rotated ~ 0 run function anemoland:sys/entity/common/rot2vec/0
# execute if score @s action_time matches 11..20 run data modify entity @s Motion set from storage temp:_ data.vec

execute if score @s action_time matches 2 rotated ~150 0 positioned ^ ^ ^3 rotated ~ ~ run function rpg:sys/entity/mob/martellos/tick/action/spin_dirt/launch
execute if score @s action_time matches 4 rotated ~190 0 positioned ^ ^ ^3 rotated ~ ~ run function rpg:sys/entity/mob/martellos/tick/action/spin_dirt/launch
execute if score @s action_time matches 6 rotated ~230 0 positioned ^ ^ ^3 rotated ~ ~ run function rpg:sys/entity/mob/martellos/tick/action/spin_dirt/launch
execute if score @s action_time matches 8 rotated ~270 0 positioned ^ ^ ^3 rotated ~ ~ run function rpg:sys/entity/mob/martellos/tick/action/spin_dirt/launch
execute if score @s action_time matches 10 rotated ~310 0 positioned ^ ^ ^3 rotated ~ ~ run function rpg:sys/entity/mob/martellos/tick/action/spin_dirt/launch
execute if score @s action_time matches 12 rotated ~350 0 positioned ^ ^ ^3 rotated ~ ~ run function rpg:sys/entity/mob/martellos/tick/action/spin_dirt/launch
# execute if score @s action_time matches 14 rotated ~390 0 positioned ^ ^ ^3 rotated ~ ~ run function rpg:sys/entity/mob/martellos/tick/action/spin_dirt/launch

execute if score @s action_time matches ..20 run function rpg:sys/entity/mob/martellos/tick/action/12_spin/attack
...
execute if score @s action_time matches 60.. run function rpg:sys/entity/mob/martellos/tick/action/spin_dirt/2_cooltime/start
