...
execute if score @s action_way matches 0 run function rpg:sys/entity/mob/martellos/animation/spin_dirt_left1
execute if score @s action_way matches 1 run function rpg:sys/entity/mob/martellos/animation/spin_dirt_right1
