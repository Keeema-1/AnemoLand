...
execute if score @s action_time matches 60 rotated ~ 0 positioned ^ ^ ^-6 run function anemoland_contents:sys/entity/mob/martellos/tick/action/knock_tail/1_knock/particle
execute if score @s action_time matches 52..60 run function anemoland_contents:sys/entity/mob/martellos/tick/action/knock_tail/attack

execute if score @s action_time matches ..10 unless score #hostile_target.is_player temp matches 1 unless entity @e[type=#anemoland:mob_core,tag=hostile_target,distance=..4,limit=1] run data modify storage temp:_ data.rot2vec set value {abs:0.1}
...
execute if score @s action_time matches ..10 unless score #hostile_target.is_player temp matches 1 rotated ~ 0 positioned ^ ^ ^-7 facing entity @e[type=#anemoland:mob_core,tag=hostile_target,distance=..32,limit=1] feet rotated ~ 0 run function anemoland:sys/entity/common/rot2vec/0
...
execute if score @s action_time matches 25..35 unless score #hostile_target.is_player temp matches 1 unless entity @e[type=#anemoland:mob_core,tag=hostile_target,distance=..4,limit=1] run data modify storage temp:_ data.rot2vec set value {abs:0.7}
...
execute if score @s action_time matches 36..45 unless score #hostile_target.is_player temp matches 1 unless entity @e[type=#anemoland:mob_core,tag=hostile_target,distance=..4,limit=1] run data modify storage temp:_ data.rot2vec set value {abs:0.3}
...
execute if score @s action_time matches 46..55 unless score #hostile_target.is_player temp matches 1 unless entity @e[type=#anemoland:mob_core,tag=hostile_target,distance=..4,limit=1] run data modify storage temp:_ data.rot2vec set value {abs:0.15}
...
execute if score @s action_time matches 140.. run function anemoland_contents:sys/entity/mob/martellos/tick/action/knock_tail/end
execute if entity @s[tag=angry] if score @s action_time matches 120.. run function anemoland_contents:sys/entity/mob/martellos/tick/action/knock_tail/end
