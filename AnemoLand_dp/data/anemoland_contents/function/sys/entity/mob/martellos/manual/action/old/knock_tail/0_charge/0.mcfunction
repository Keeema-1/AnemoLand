...
execute if entity @s[tag=angry] if score @s action_time matches 30.. run function rpg:sys/entity/mob/martellos/tick/action/knock_tail/1_knock/start

execute if score @s action_time matches 40.. run function rpg:sys/entity/mob/martellos/tick/action/knock_tail/1_knock/start
