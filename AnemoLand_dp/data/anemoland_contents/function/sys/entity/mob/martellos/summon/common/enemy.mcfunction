tag @s add enemy
function anemoland_contents:sys/entity/mob/martellos/summon/common/status
# ボーナス
...
# ゴールド
    ...
    scoreboard players add @s gold 400
...
# XP
    scoreboard players set @s xp 100
    scoreboard players operation @s xp *= #new_entity.level temp
    scoreboard players add @s xp 400
