...
# プレイヤーの方に回転
    ...
    execute if score @s action_time matches 31.. run function anemoland:sys/entity/common/rotate/to_player/front/3

execute if score @s action_time matches 35.. run function anemoland_contents:sys/entity/mob/garapapas/manual/action/water_front/1/start
execute if entity @s[tag=angry] if score @s action_time matches 25.. run function anemoland_contents:sys/entity/mob/garapapas/manual/action/water_front/1/start
