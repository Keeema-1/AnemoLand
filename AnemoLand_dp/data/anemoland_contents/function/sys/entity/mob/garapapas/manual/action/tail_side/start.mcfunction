#> anemoland_contents:sys/entity/mob/garapapas/manual/action/tail_side/start
#
# アクション tail_side の開始時に実行される
# このファイルは初回のみ自動生成される
# アクション開始時の処理をこの下に記述
#
# @within function anemoland_contents:sys/entity/mob/garapapas/action/tail_side/start
...
execute if score @s action_way matches 0 run function anemoland_contents:sys/entity/mob/garapapas/animation/tail_left1
execute if score @s action_way matches 1 run function anemoland_contents:sys/entity/mob/garapapas/animation/tail_right1
