...
execute if score @s action_time matches 40.. run function anemoland_contents:sys/entity/mob/garapapas/manual/action/bite/1/start
execute if entity @s[tag=angry] if score @s action_time matches 35.. run function anemoland_contents:sys/entity/mob/garapapas/manual/action/bite/1/start
