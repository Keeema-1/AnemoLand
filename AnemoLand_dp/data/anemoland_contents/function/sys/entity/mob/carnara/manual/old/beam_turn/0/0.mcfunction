...
execute if score @s action_time matches 41..60 if score #target_is_leftside temp matches 1 at @s run tp @s ~ ~ ~ ~-1 ~
execute if score @s action_time matches 41..60 unless score #target_is_leftside temp matches 1 at @s run tp @s ~ ~ ~ ~1 ~
execute if score @s action_time matches 61.. if score #target_is_leftside temp matches 1 at @s run tp @s ~ ~ ~ ~-0.5 ~
execute if score @s action_time matches 61.. unless score #target_is_leftside temp matches 1 at @s run tp @s ~ ~ ~ ~0.5 ~
...
execute if score @s action_time matches 70.. run function anemoland_contents:sys/entity/mob/carnara/manual/action/beam_turn/1/start
execute if entity @s[tag=angry] if score @s action_time matches 60.. run function anemoland_contents:sys/entity/mob/carnara/manual/action/beam_turn/1/start
