...
execute if entity @s[tag=hitbox.body] run scoreboard players set @s armor.fire.mul 110
...
execute if entity @s[tag=hitbox.head] run scoreboard players set @s armor.fire.mul 180
execute if entity @s[tag=hitbox.head] run scoreboard players set @s armor.ice.mul 80
