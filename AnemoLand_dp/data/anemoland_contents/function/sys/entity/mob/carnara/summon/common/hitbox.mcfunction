...
execute if entity @s[tag=hitbox.body] run attribute @s scale base set 3.5
execute if entity @s[tag=hitbox.body] run scoreboard players set @s armor.mul 80
execute if entity @s[tag=hitbox.body] run scoreboard players set @s armor.fire.mul 150
execute if entity @s[tag=hitbox.body] run scoreboard players set @s armor.ice.mul 50
execute if entity @s[tag=hitbox.head] run attribute @s scale base set 3.5
...
execute if entity @s[tag=hitbox.head] run scoreboard players set @s armor.ice.mul 50
execute if entity @s[tag=hitbox.neck] run attribute @s scale base set 3.5
...
execute if entity @s[tag=hitbox.neck] run scoreboard players set @s armor.ice.mul 50
execute if entity @s[tag=hitbox.tail] run attribute @s scale base set 3.5
execute if entity @s[tag=hitbox.tail] run scoreboard players set @s armor.mul 120
execute if entity @s[tag=hitbox.tail] run scoreboard players set @s armor.fire.mul 150
execute if entity @s[tag=hitbox.tail] run scoreboard players set @s armor.ice.mul 50
