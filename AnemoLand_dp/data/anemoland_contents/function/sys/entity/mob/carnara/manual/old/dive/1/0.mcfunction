...
execute if score @s action_time matches 20..30 run function anemoland_contents:sys/entity/mob/carnara/attack/dive1/0

execute if score @s action_time matches 100.. run function anemoland_contents:sys/entity/mob/carnara/manual/action/dive/end
