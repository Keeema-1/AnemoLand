...
execute if score @s action_time matches 11.. if score #hostile_target.is_player temp matches 1 rotated ~ 0 positioned ^ ^ ^16 facing entity @a[tag=hostile_target,distance=..32,limit=1] feet rotated ~ 0 run function anemoland:sys/entity/common/rot2vec/0
execute if score @s action_time matches 11.. unless score #hostile_target.is_player temp matches 1 rotated ~ 0 positioned ^ ^ ^16 facing entity @e[type=#anemoland:mob_core,tag=hostile_target,distance=..32,limit=1] feet rotated ~ 0 run function anemoland:sys/entity/common/rot2vec/0
...
execute if score @s action_time matches 60.. run function anemoland_contents:sys/entity/mob/carnara/manual/action/tail_spear/1/start
execute if entity @s[tag=angry] if score @s action_time matches 50.. run function anemoland_contents:sys/entity/mob/carnara/manual/action/tail_spear/1/start
