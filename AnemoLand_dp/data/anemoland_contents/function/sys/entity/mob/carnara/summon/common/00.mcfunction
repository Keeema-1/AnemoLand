...
execute if data storage temp:_ data.new_entity{"variant":"default"} rotated ~ 0 run function animated_java:carnara/summon {args:{variant:"default",animation:"default",start_animation:true}}
