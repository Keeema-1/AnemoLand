...
execute if score @s action_time matches 170.. run return run function anemoland_contents:sys/entity/mob/carnara/action/beam_high/end
execute if entity @s[tag=angry] if score @s action_time matches 160.. run return run function anemoland_contents:sys/entity/mob/carnara/action/beam_high/end
