...
execute if entity @s[tag=!pet_bullet] rotated ~ 0 positioned ~-3 ~-3 ~-3 as @a[dx=5,dy=5,dz=5,scores={hurt_time=-1},gamemode=adventure,limit=1] positioned ~3 ~3 ~3 run function anemoland_contents:sys/entity/bullet/firework/attack/default/to_player
