...
# ブロックディスプレイを乗せる
    summon block_display ~ ~ ~ {Tags:["newly_summoned"],block_state:{Name:"copper_block"},billboard:"fixed",transformation:[1.0000f,0.0000f,0.0000f,-0.5000f,0.0000f,1.0000f,0.0000f,-0.5000f,0.0000f,0.0000f,1.0000f,-0.5000f,0.0000f,0.0000f,0.0000f,1.0000f],shadow_strength:1,shadow_radius:1.0}
