...
execute if entity @s[tag=!pet_bullet] rotated ~ 0 positioned ~-2 ~-2 ~-2 as @a[dx=3,dy=3,dz=3,scores={hurt_time=-1},gamemode=adventure,limit=1] run function anemoland_contents:sys/entity/bullet/water/attack/to_player
