#> anemoland_contents:sys/entity/bullet/water/summon/large/0
#
# 水の弾を発射する
#
# @input
...
# 召喚
    execute rotated ~ 0 positioned ~ ~ ~ summon armor_stand run function anemoland_contents:sys/entity/bullet/water/summon/large/00
