#> anemoland_contents:sys/entity/bullet/dirt/summon/ice/0
#
# 氷の弾を発射する
#
# @input
...
# 召喚
    execute rotated ~ 0 positioned ~ ~ ~ summon armor_stand run function anemoland_contents:sys/entity/bullet/dirt/summon/ice/00
