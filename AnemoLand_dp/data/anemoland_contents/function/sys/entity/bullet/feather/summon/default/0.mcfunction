#> anemoland_contents:sys/entity/bullet/feather/summon/default/0
#
# 羽を発射する
#
# @input
...
# 召喚
    execute rotated ~ ~ positioned ~ ~ ~ summon armor_stand run function anemoland_contents:sys/entity/bullet/feather/summon/default/00
