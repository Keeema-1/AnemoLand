...
execute unless score @s action_time matches 80 at @s if block ~ ~ ~ #rpg:space positioned ~-2 ~-1 ~-2 if entity @a[dx=3,dy=3,dz=3,gamemode=adventure] positioned ~2 ~1 ~2 run function rpg:sys/entity/bullet/firework/tick/blast

execute unless score @s action_time matches 80 at @s unless block ~ ~ ~ #rpg:space positioned ~ ~1 ~ run function rpg:sys/entity/bullet/firework/tick/blast

execute if score @s action_time matches 80 run function rpg:sys/entity/bullet/firework/tick/blast
