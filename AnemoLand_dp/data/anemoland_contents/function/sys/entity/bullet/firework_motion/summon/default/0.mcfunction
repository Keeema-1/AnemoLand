#> anemoland_contents:sys/entity/bullet/firework/summon/default/0
#
# 花火弾を発射する
#
# @input
...
# 召喚
    execute rotated ~ 0 positioned ~ ~ ~ summon armor_stand run function anemoland_contents:sys/entity/bullet/firework_motion/summon/default/00
