execute if entity @s[tag=human1] run function anemoland_contents:sys/entity/mob/human1/damaged/0
execute if entity @s[tag=decoy1] run function anemoland_contents:sys/entity/mob/decoy1/damaged/0
