...
scoreboard players set #movie.bagikeros action0 3
...
execute as @e[tag=aj.bagikeros.root,distance=..64] run function animated_java:bagikeros/animations/shake_walk_start/play
