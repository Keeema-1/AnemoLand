...
execute if score #movie.martellos action_time matches 40 at @e[tag=aj.martellos.root,distance=..64] rotated ~ 0 positioned ^ ^-2 ^2 run function anemoland_contents:sys/entity/mob/martellos/manual/tick/action/knock/1/particle
