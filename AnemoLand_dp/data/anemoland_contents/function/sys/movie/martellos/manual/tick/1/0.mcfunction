...
execute if score #movie.martellos action_time matches 0 as @e[tag=aj.martellos.root,distance=..64] run function animated_java:martellos/animations/knock_right1/play
...
execute if score #movie.martellos action_time matches 30 as @e[tag=aj.martellos.root,distance=..64] run function animated_java:martellos/animations/knock_right2/play
...
execute as @e[type=armor_stand,tag=movie.martellos,distance=..64] run tp @s ~ 3.0 ~5 150 20

execute if score #movie.martellos action_time matches 60.. run function anemoland_contents:sys/movie/martellos/manual/tick/2/start
