...
execute if score #movie.muscleroom action0 matches 7 run function anemoland_contents:sys/movie/muscleroom/manual/tick/7/0
execute if score #movie.muscleroom action0 matches 8 run function anemoland_contents:sys/movie/muscleroom/manual/tick/8/0
execute if score #movie.muscleroom action0 matches 9 run function anemoland_contents:sys/movie/muscleroom/manual/tick/9/0
