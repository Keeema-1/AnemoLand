...
scoreboard players set #movie.garapapas action0 3
...
execute as @e[tag=aj.garapapas.root,distance=..64] run function animated_java:garapapas/animations/water_front1/play
