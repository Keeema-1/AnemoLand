...
item modify entity @s inventory.3 anemoland_contents:player_menu/main/status/skill/stamina_recovery
item modify entity @s inventory.4 anemoland_contents:player_menu/main/status/skill/stamina_recovery
