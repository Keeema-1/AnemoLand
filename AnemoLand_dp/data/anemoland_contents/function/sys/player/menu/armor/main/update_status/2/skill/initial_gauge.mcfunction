...
scoreboard players set #const temp 10
scoreboard players operation #skill_level.decimal1 temp /= #const temp
item modify entity @s inventory.3 anemoland_contents:player_menu/main/status/skill/initial_gauge
item modify entity @s inventory.4 anemoland_contents:player_menu/main/status/skill/initial_gauge
