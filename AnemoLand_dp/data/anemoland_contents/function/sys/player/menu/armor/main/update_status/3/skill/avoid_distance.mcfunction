...
item modify entity @s inventory.5 anemoland_contents:player_menu/main/status/skill/avoid_distance
item modify entity @s inventory.6 anemoland_contents:player_menu/main/status/skill/avoid_distance
