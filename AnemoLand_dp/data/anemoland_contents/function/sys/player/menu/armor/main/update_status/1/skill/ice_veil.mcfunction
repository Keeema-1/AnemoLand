...
item modify entity @s inventory.1 anemoland_contents:player_menu/main/status/skill/ice_veil
item modify entity @s inventory.2 anemoland_contents:player_menu/main/status/skill/ice_veil
