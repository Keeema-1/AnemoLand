...
item modify entity @s inventory.3 anemoland_contents:player_menu/main/status/skill/depth_strider
item modify entity @s inventory.4 anemoland_contents:player_menu/main/status/skill/depth_strider
