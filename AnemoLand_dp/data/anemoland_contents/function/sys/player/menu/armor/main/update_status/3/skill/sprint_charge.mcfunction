...
item modify entity @s inventory.5 anemoland_contents:player_menu/main/status/skill/sprint_charge
item modify entity @s inventory.6 anemoland_contents:player_menu/main/status/skill/sprint_charge
