...
item modify entity @s inventory.3 anemoland_contents:player_menu/main/status/skill/ice_veil
item modify entity @s inventory.4 anemoland_contents:player_menu/main/status/skill/ice_veil
