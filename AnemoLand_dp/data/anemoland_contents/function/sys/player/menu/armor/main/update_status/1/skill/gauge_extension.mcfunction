...
scoreboard players set #const temp 10
scoreboard players operation #skill_level.decimal1 temp /= #const temp
item modify entity @s inventory.1 anemoland_contents:player_menu/main/status/skill/gauge_extension
item modify entity @s inventory.2 anemoland_contents:player_menu/main/status/skill/gauge_extension
