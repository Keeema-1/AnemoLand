execute store result score #skill_level temp run data get storage temp:_ data.player_storage.skill_levels.avoid_distance 10
...
scoreboard players operation #skill_level.decimal1 temp /= #const temp
item modify entity @s inventory.5 anemoland_contents:skill/avoid_distance
item modify entity @s inventory.6 anemoland_contents:skill/avoid_distance
