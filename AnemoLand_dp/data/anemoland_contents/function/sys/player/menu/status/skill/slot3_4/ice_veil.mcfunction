execute store result score #skill_level temp run data get storage temp:_ data.player_storage.skill_levels.ice_veil 10
...
scoreboard players operation #skill_level.decimal1 temp /= #const temp
item modify entity @s inventory.3 anemoland_contents:skill/ice_veil
item modify entity @s inventory.4 anemoland_contents:skill/ice_veil
