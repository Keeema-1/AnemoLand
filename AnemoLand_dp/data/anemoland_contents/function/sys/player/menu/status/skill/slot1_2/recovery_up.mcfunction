execute store result score #skill_level temp run data get storage temp:_ data.player_storage.skill_levels.recovery_up 1
...
scoreboard players operation #skill_level.decimal1 temp /= #const temp
item modify entity @s inventory.1 anemoland_contents:skill/recovery_up
item modify entity @s inventory.2 anemoland_contents:skill/recovery_up
