execute store result score #skill_level temp run data get storage temp:_ data.player_storage.skill_levels.stamina_recovery 10
...
scoreboard players operation #skill_level.decimal1 temp /= #const temp
item modify entity @s inventory.5 anemoland_contents:skill/stamina_recovery
item modify entity @s inventory.6 anemoland_contents:skill/stamina_recovery
