execute store result score #skill_level temp run data get storage temp:_ data.player_storage.skill_levels.jump_attack 10
...
scoreboard players operation #skill_level.decimal1 temp /= #const temp
item modify entity @s inventory.1 anemoland_contents:skill/jump_attack
item modify entity @s inventory.2 anemoland_contents:skill/jump_attack
