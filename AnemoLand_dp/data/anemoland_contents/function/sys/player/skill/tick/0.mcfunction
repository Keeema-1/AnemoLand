...
execute if score @s sprint_time matches 40 if data storage temp:_ data.player_storage.skill_levels.sprint_charge run particle minecraft:dust{color:[1.0, 0.0, 0.0], scale:1.0} ~ ~1 ~ 0.3 0.6 0.3 1 10
