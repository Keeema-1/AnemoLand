...
execute if data storage temp:_ data.player_storage.skill_levels.dust_avoiding if score @s area2 matches 1.. run function rpg:sys/player/skill/avoid/dust_avoiding/0
