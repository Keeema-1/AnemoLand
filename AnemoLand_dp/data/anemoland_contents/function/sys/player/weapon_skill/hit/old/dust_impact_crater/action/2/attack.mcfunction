...
data modify storage temp:_ data.weapon_skill_data set value {gauge_consume:100,id:"impact_crater","mul":80}
...
execute store result score #damage.src.attack.mul temp run data get storage temp:_ data.weapon_skill_data.mul 0.1251

# tellraw @a {"score":{"name":"#damage.src.attack.mul","objective":"temp"}}
# tellraw @a {"storage":"temp:_","nbt":"data.weapon_skill_data"}
...
# execute rotated ~60 0 positioned ^ ^ ^2.5 positioned ~-1 -0.5 ~-1 as @e[type=#anemoland:mob_core,tag=enemy,dx=1,dy=1,dz=1,sort=nearest,limit=1] run function anemoland_contents:sys/entity/branch/damaged_by_player
# execute rotated ~120 0 positioned ^ ^ ^2.5 positioned ~-1 -0.5 ~-1 as @e[type=#anemoland:mob_core,tag=enemy,dx=1,dy=1,dz=1,sort=nearest,limit=1] run function anemoland_contents:sys/entity/branch/damaged_by_player
...
# execute rotated ~240 0 positioned ^ ^ ^2.5 positioned ~-1 -0.5 ~-1 as @e[type=#anemoland:mob_core,tag=enemy,dx=1,dy=1,dz=1,sort=nearest,limit=1] run function anemoland_contents:sys/entity/branch/damaged_by_player
# execute rotated ~300 0 positioned ^ ^ ^2.5 positioned ~-1 -0.5 ~-1 as @e[type=#anemoland:mob_core,tag=enemy,dx=1,dy=1,dz=1,sort=nearest,limit=1] run function anemoland_contents:sys/entity/branch/damaged_by_player
...
function anemoland:sys/player/item/weapon/weapon_skill/dust_impact_crater/action/end
