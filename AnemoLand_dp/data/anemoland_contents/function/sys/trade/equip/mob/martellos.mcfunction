...
loot replace entity @s weapon.mainhand loot anemoland_contents:item/armor/martellos/helmet/1
...
data modify storage temp:_ data.recipe.buyB set from entity @s HandItems[0]
data modify storage temp:_ data.recipe.buyB.count set value 5
loot replace entity @s weapon.mainhand loot anemoland_contents:item/armor/martellos/chestplate/1
data modify storage temp:_ data.recipe.sell set from entity @s HandItems[0]
execute if data storage anemoland:progress data.armor.martellos{unlocked:1b} run data modify storage temp:_ data.Recipes append from storage temp:_ data.recipe
...
data modify storage temp:_ data.recipe.buyB set from entity @s HandItems[0]
data modify storage temp:_ data.recipe.buyB.count set value 5
loot replace entity @s weapon.mainhand loot anemoland_contents:item/armor/martellos/leggings/1
data modify storage temp:_ data.recipe.sell set from entity @s HandItems[0]
execute if data storage anemoland:progress data.armor.martellos{unlocked:1b} run data modify storage temp:_ data.Recipes append from storage temp:_ data.recipe
...
data modify storage temp:_ data.recipe.buyB set from entity @s HandItems[0]
data modify storage temp:_ data.recipe.buyB.count set value 5
loot replace entity @s weapon.mainhand loot anemoland_contents:item/armor/martellos/boots/1
data modify storage temp:_ data.recipe.sell set from entity @s HandItems[0]
execute if data storage anemoland:progress data.armor.martellos{unlocked:1b} run data modify storage temp:_ data.Recipes append from storage temp:_ data.recipe
...
loot replace entity @s weapon.mainhand loot anemoland_contents:item/weapon/martellos_hammer/1
data modify storage temp:_ data.recipe.sell set from entity @s HandItems[0]
execute if data storage anemoland:progress data.armor.martellos{unlocked:1b} run data modify storage temp:_ data.Recipes append from storage temp:_ data.recipe
