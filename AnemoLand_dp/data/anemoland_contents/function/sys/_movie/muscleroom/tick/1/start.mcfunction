...
scoreboard players set #movie.muscleroom action0 1
...
execute as @e[tag=aj.muscleroom.root,distance=..64] run function animated_java:muscleroom/animations/ground1/play
