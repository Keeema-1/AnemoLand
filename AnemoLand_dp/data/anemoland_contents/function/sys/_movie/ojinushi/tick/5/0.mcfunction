...
execute if score #movie.ojinushi action_time matches 18..20 as @e[tag=aj.ojinushi.root,distance=..64] at @s run particle explosion ^ ^-2 ^3 0 0 0 1 1
execute if score #movie.ojinushi action_time matches 20 as @a[distance=..64] at @s run playsound entity.generic.explode hostile @s ~ ~ ~ 2 1
