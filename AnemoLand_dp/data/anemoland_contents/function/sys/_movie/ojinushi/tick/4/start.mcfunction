...
scoreboard players set #movie.ojinushi action0 4
...
execute as @e[tag=aj.ojinushi.root,distance=..64] run function animated_java:ojinushi/animations/right_punch1/play
