...
execute if score #movie.ojinushi action_time matches 18 as @e[tag=aj.ojinushi.root,distance=..64] at @s positioned ~ ~-2 ~ run function anemoland_contents:sys/entity/mob/ojinushi/tick/action/jump_launch/1/launch1
execute if score #movie.ojinushi action_time matches 21 as @e[tag=aj.ojinushi.root,distance=..64] at @s positioned ~ ~-2 ~ run function anemoland_contents:sys/entity/mob/ojinushi/tick/action/jump_launch/1/launch2
execute if score #movie.ojinushi action_time matches 24 as @e[tag=aj.ojinushi.root,distance=..64] at @s positioned ~ ~-2 ~ run function anemoland_contents:sys/entity/mob/ojinushi/tick/action/jump_launch/1/launch3
