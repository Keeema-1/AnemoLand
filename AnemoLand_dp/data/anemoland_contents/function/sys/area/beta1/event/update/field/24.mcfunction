...
execute if score #random temp matches 34..43 unless score #level temp matches 1.. run data modify storage temp:_ data.field_event.level set value 5
execute if score #random temp matches 34..43 unless score #level temp matches ..8 run data modify storage temp:_ data.field_event.level set value 40
...
execute if score #random temp matches 44..47 unless score #level temp matches 4.. run data modify storage temp:_ data.field_event.level set value 20
execute if score #random temp matches 44..47 unless score #level temp matches ..8 run data modify storage temp:_ data.field_event.level set value 40
