...
# フィールドidとレベルをセット
    data modify storage temp:_ data.field_event set value {field_id:31,level:10}
...
execute if score #random temp matches 65..84 unless score #level temp matches 2.. run data modify storage temp:_ data.field_event.level set value 10
execute if score #random temp matches 65..84 unless score #level temp matches ..8 run data modify storage temp:_ data.field_event.level set value 40
...
execute if score #random temp matches 85..88 unless score #level temp matches 4.. run data modify storage temp:_ data.field_event.level set value 20
execute if score #random temp matches 85..88 unless score #level temp matches ..8 run data modify storage temp:_ data.field_event.level set value 40
...
execute if score #random temp matches 89..89 unless score #level temp matches 4.. run data modify storage temp:_ data.field_event.level set value 20
execute if score #random temp matches 89..89 unless score #level temp matches ..8 run data modify storage temp:_ data.field_event.level set value 40
