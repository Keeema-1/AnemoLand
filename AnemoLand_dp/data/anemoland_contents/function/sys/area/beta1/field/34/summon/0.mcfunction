...
execute unless data storage temp:_ data.event{with_npc1:1b} if data storage anemoland:progress data.beta1.field.34{cleared_once:1b} at @p run function anemoland:sys/player/area/common/field/summon_npc
...
execute if data storage anemoland:progress data.beta1.field.34.event{wave:1} run data modify storage temp:_ data.wave set from storage anemoland:progress data.beta1.field.34.event.waves[0]
execute if data storage anemoland:progress data.beta1.field.34.event{wave:2} run data modify storage temp:_ data.wave set from storage anemoland:progress data.beta1.field.34.event.waves[1]
execute if data storage anemoland:progress data.beta1.field.34.event{wave:3} run data modify storage temp:_ data.wave set from storage anemoland:progress data.beta1.field.34.event.waves[2]
