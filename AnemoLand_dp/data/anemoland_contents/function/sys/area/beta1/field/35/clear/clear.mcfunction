...
data modify storage anemoland:progress data.beta1.field.35.cleared set value 1b
data modify storage anemoland:progress data.beta1.field.35.cleared_once set value 1b
data modify storage anemoland:progress data.beta1.field.35.event.random_event_enable set value 1b
function anemoland_contents:sys/area/beta1/field/35/clear/clear_
data modify storage temp:_ data.event_id.event_id set from storage anemoland:progress data.beta1.field.35.event.event_id
function anemoland_contents:sys/event/clear with storage temp:_ data.event_id
function anemoland_contents:command/field_event/beta1/change/squirrel_head_15 {field_id:35}
