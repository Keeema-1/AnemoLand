...
execute unless data storage temp:_ data.event{with_npc1:1b} if data storage anemoland:progress data.beta1.field.61{cleared_once:1b} at @p run function anemoland:sys/player/area/common/field/summon_npc
