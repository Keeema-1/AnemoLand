...
# forceload
    execute positioned 2560.0 0.0 1536.0 run forceload add ~-32 ~-32 ~32 ~32
    schedule function anemoland_contents:sys/area/beta1/field/21/init/forceload_remove 5s replace
