...
# forceload
    execute positioned 1024.0 0.0 1024.0 run forceload add ~-32 ~-32 ~32 ~32
    schedule function anemoland_contents:sys/area/beta1/field/25/init/forceload_remove 5s replace
