...
execute if entity @s[tag=aj.martellos.animation.knock_right.playing] run function animated_java:martellos/animations/knock_right/zzz/on_tick
execute if entity @s[tag=aj.martellos.animation.knock_left.playing] run function animated_java:martellos/animations/knock_left/zzz/on_tick
...
execute if entity @s[tag=aj.martellos.animation.spin_right.playing] run function animated_java:martellos/animations/spin_right/zzz/on_tick
