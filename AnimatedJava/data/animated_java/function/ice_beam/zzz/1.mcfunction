...
execute on vehicle on passengers if entity @s[tag=aj.ice_beam.bone.bone] run function animated_java:global/internal/gu/convert_uuid_array_to_string with entity @s
